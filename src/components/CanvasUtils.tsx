...
export function CanvasUtils({ inputBlocks, setInputBlocks, imageBlocks, setImageBlocks, objBlocksTriangle, setObjBlocksTriangle, objBlocksSquare, setObjBlocksSquare, objBlocksCircle, setObjBlocksCircle }: CanvasUtilsProps) {

...
import colorsStyle from "./colors.module.css";
...
export function PopupColors({ close }: PopupProps) {
  ...
  return (
    <>
      ...
      <div style={{ display: popupStyle, width: "300px", height: "300px" }} className={styles.popup}>
        ...
        <div className={styles.flex_block}>
          ...
          >
            ...
            <div style={styleColor} className={colorsStyle.colorPreview}></div>
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <div style={styleColorBack} className={colorsStyle.colorPreview}></div>
          </div>
        </div>

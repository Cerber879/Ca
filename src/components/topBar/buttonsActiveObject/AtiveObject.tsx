...
export function ActiveObject() {
  ...
  const offFill = () => {
    objFillStatusProcessing(
      "objFillClick",
      dispatch,
      objFillSettSlice.activeObjFill,
      "svg_icon_fill"
    );
  };
  const offStroke = () => {
    objStrokeStatusProcessing(
      "objStrokeClick",
      dispatch,
      objStrokeSettSlice.activeObjStroke,
      "svg_icon_stroke"
    );
  };
  const offStrFill = () => {
    objStrokeFillStatusProcessing(
      "objStrokeFillClick",
      dispatch,
      objStrokeFillSettSlice.activeObjStrokeFill,
      "svg_icon_fill_stroke"
    );
  };
  ...
  return (
    <>
      <button
        ...
        onClick={() => {
          if (objFillSettSlice.activeObjFill) offFill();
          if (objStrokeFillSettSlice.activeObjStrokeFill) offStrFill();
          objStrokeStatusProcessing(
            "objStrokeClick",
            dispatch,
            objStrokeSettSlice.activeObjStroke,
      ...
      <button
        ...
        onClick={() => {
          if (objStrokeSettSlice.activeObjStroke) offStroke();
          if (objStrokeFillSettSlice.activeObjStrokeFill) offStrFill();
          objFillStatusProcessing(
            "objFillClick",
            dispatch,
      ...
      >
        <img
          id="svg_icon_fill_stroke"
          src={
            !objStrokeFillSettSlice.activeObjStrokeFill
              ? "/images/fill_stroke.svg"
              : "/images/fill_stroke_active.svg"
          }
          alt="Icon"
          width="15"
          height="15"

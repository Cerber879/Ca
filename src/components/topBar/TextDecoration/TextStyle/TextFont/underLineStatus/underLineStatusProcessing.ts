import { setActiveTextUnderLine, setBtnStyleTextUnderLine } from "./underLineSettings"
import { AnyAction, Dispatch } from "redux";

export function TextUnderLineStatusProcessing(nameProcess: string, dispatch: Dispatch<AnyAction>, activeTextUnderLine: boolean, id: string) {
    switch(nameProcess) {

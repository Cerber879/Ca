...
const svgStyle = {
  enableBackground: "new 0 0 355.189 355.189",
} as React.CSSProperties;

const TextBold = ({ fill }: { fill: string }) => {
  return (
    <svg
      width={15}
      height={15}
